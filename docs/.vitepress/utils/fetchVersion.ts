/*
  ...
  return fetch('https://api.github.com/repos/liulihao88/docs/contents/package.json?ref=master', {
    headers: {
  ...
  return fetch('https://raw.githubusercontent.com/liulihao88/docs/master/package.json')
*/
